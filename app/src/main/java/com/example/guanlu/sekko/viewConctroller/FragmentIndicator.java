...
//    private  static final int SELECTED = 0xFF6B5A7A;
    private  static final int SELECTED = 0xffe0532e;
    private  static final int UNSELECTED = 0xfff4f4f4;
//    private  static final int UNSELECTED = 0xfffbe9e7;
    ...
    private void init() {
        ...
        //默认第一个界面
        mIndicators[0] = createIndicator(R.string.movie, Color.BLACK,TAG_TEXT_0,
                TAG_ICON_0,R.drawable.ic_movie_black_24dp);
        mIndicators[0].setBackgroundColor(UNSELECTED);
        ...
        mIndicators[1] = createIndicator(R.string.cinema,Color.BLACK,TAG_TEXT_1,
                TAG_ICON_1,R.drawable.ic_cinema_black_24dp);
        mIndicators[1].setBackgroundColor(UNSELECTED);
        mIndicators[1].setTag(Integer.valueOf(1));
        mIndicators[1].setOnClickListener(this);
        addView(mIndicators[1]);


        mIndicators[2] = createIndicator(R.string.dating,Color.BLACK,TAG_TEXT_2,
                TAG_ICON_2,R.drawable.ic_dating_black_24dp);
        mIndicators[2].setBackgroundColor(UNSELECTED);
    ...
    public static void setIndicator(int which) {
            mIndicators[mCurIndicator].setBackgroundColor(UNSELECTED);
        TextView prevText;
        ImageView prevIcon;
        ...
        switch(mCurIndicator) {
            case 0:
                ...
                prevText.setTextColor(SELECTED);
                prevIcon.setImageResource(R.drawable.ic_movie_black_24dp);
                break;
            case 1:
                ...
                prevText.setTextColor(SELECTED);
                prevIcon.setImageResource(R.drawable.ic_cinema_black_24dp);
                break;
            case 2:
                ...
                prevText.setTextColor(SELECTED);
                prevIcon.setImageResource(R.drawable.ic_dating_black_24dp);
                break;
        }


        mIndicators[which].setBackgroundColor(SELECTED);
        TextView curText;
        ImageView curIcon;
        ...
        switch(which) {
            case 0:
                ...
                curIcon.setImageResource(R.drawable.ic_movie_white_24dp);
                break;
            case 1:
                ...
                curText.setTextColor(COLOR_WHITE);
                curIcon.setImageResource(R.drawable.ic_cinema_white_24dp);
                break;
            case 2:
                ...
                curText.setTextColor(COLOR_WHITE);
                curIcon.setImageResource(R.drawable.ic_dating_white_24dp);
                break;
        }
        mCurIndicator = which;
    }
